...
--
-- Host: localhost
-- Generation Time: Jan 17, 2021 at 09:15 PM
...
INSERT INTO `user_certificate` (`crt_id`, `crt_name`, `crt_user_id`) VALUES
(10, 'ArshadMansuri_ Resume_TIMSCDR.pdf', 9);
...
CREATE TABLE `user_details` (
  ...
  `user_profession` enum('Salaried','Self-employed') NOT NULL,
  `user_company_name` varchar(255) DEFAULT NULL,
  `user_job_start_date` varchar(20) DEFAULT NULL,
  `user_business_name` varchar(255) DEFAULT NULL,
...
INSERT INTO `user_details` (`user_id`, `user_name`, `user_dob`, `user_gender`, `user_state`, `user_city`, `user_image`, `user_skill`, `user_profession`, `user_company_name`, `user_job_start_date`, `user_business_name`, `user_location`, `user_email`, `user_mobile`) VALUES
(9, 'Arshad Mansuri', '1997-05-27', 'MALE', 'Maharashtra', 'Mumbai', 'Arshad-formal-whiteBG.png', 'FLUTTER-PYTHON', 'Self-employed', '', '', 'Ash Tech', 'Mumbai', 'mansuriarshad004@gmail.com', '7738866043');
...
CREATE TABLE `user_education` (
  ...
  `edu_year_completion` varchar(255) NOT NULL,
...
INSERT INTO `user_education` (`edu_id`, `edu_name`, `edu_year_completion`, `edu_user_id`) VALUES
(12, 'BSCIT', '2018', 9),
(13, 'MCA', '2021', 9);
...
--
ALTER TABLE `user_certificate`
  MODIFY `crt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
